...
\section{Ikke-funksjonelle krav}
    ...
    \subsection{Avhengigheter}
        ...
        \subsubsection{JavaJDK 11}
        \IFK
        Kompilerer og kjører back-end koden.

        \subsubsection{Maven 3.6.3}
        \IFK
        Bygge automatiseringsverktøy

        \subsubsection{Javalin 3.11.0}
        \IFK
        Web rammeverk for lokal webserver

        \subsubsection{Jackson 2.11.3}
        \IFK
        Java JSON library for serialisering og deserialisering av data

        \subsubsection{JUnit-Jupiter 5.7.0}
        \IFK
        Rammeverk for testing i Java

        \subsubsection{Vue 2.6.10}
        \IFK
        Open-source Front-end modell-visning-modellvisningsrammeverk for å bygge brukergrensesnitt.

        \subsubsection{Selenium 3.141.59}
        \IFK
        Rammeverk for testing av web applikasjoner.

        \subsubsection{Webdrivermanager 4.2.2}
        \IFK
        Bibliotek for installasjon av webdrivere for bruk i testing.

        \subsubsection{Unirest 1.4.9}
        \IFK
...
\section{Prototype}
    ...
    \includegraphics[max width=\textwidth]{bilder/prototypen/klassediagram_v1.png}
    \caption*{Dette diagrammet viser den originale planlagte klassestrukturen for MVP-en}

    \includegraphics[max width=\textwidth]{bilder/prototypen/klassediagram_v2.png}
