...
\section{Funksjonelle krav}
    ...
    \subsection{Administrering}
        ...
        \subsubsection{Bedrift skal ha administrerende rettigheter på deres innlegg}
        \EsID
        Dette innebærer at bedriften kan blokkere brukere av deres parkeringsplasser fra å bruke de igjen og slette tilbakemeldinger på deres innlegg.
