...
\section{Funksjonelle krav}
    ...
    \subsection{Betaling}
        ...
        \subsubsection{Transaksjoner skal gå gjennom en tredjepart}
        \FK
...
\section{Diagrammer}
    ...
    \includegraphics[max width=\textwidth]{bilder/diagrammer/dataflyt_opprett_parkering.png}
