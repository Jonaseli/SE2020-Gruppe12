...
\section{Funksjonelle krav}
    ...
    \subsection{Persistent data}
        ...
        \subsection{Systemet skal lagre informasjon om reservasjoner}
        \FK
...
\section{Ikke-funksjonelle krav}
    ...
    \subsection{Avhengigheter}
        ...
        \IFK
        Kompilerer ok kjører back-end koden.
        ...
        \IFK
        Java JSON library for serialisering av data
