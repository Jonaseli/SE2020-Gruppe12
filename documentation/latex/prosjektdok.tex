...
\section{Estemering}
    ...
    \begin{tabular}{|p{2cm}|
        ...
        \hline
        X-Large &   \cellcolor{yellow!25}0 &
                    \cellcolor{green!25}4 &
                    \cellcolor{green!25}6 &
                    \cellcolor{green!25}7 \\
        \hline
        Large &     \cellcolor{red!25}-4 &
                    \cellcolor{yellow!25}0 &
                    \cellcolor{lime!25}2 &
                    \cellcolor{green!25}3 \\
        \hline
        Medium &    \cellcolor{red!25}-6 &
                    \cellcolor{orange!25}-2 &
                    \cellcolor{yellow!25}0 &
                    \cellcolor{lime!25}1 \\
        \hline
        Small &     \cellcolor{red!25}-7 &
                    \cellcolor{red!25}-3 &
                    \cellcolor{orange!25}-1 &
                    \cellcolor{yellow!25}0 \\
        \hline 
    \end{tabular}
