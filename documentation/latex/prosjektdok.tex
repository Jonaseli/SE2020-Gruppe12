...
\setcounter{secnumdepth}{4} % enumerate paragraph
...
\section{Funksjonelle krav}
    ...
    \subsection{Innlogging}
        ...
        \subsubsection{Lage en brukerkonto}
        \EsID
        ...
        \subsubsection{Opprette en Bedriftskonto}
        \EsID
        ...
        \subsubsection{Kode for bekreftelse}
        \EsID
    ...
    \subsection{Leie en parkeringsplass}
        ...
        \subsubsection{Hvordan finne en parkeringsplass område}
        \EsID
